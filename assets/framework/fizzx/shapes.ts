...
class ShapeCreator {
    static rect(proxy, x, y, hw, hh) {
        // return { shape: ShapeType.rect, x: x, y: y, hw: hw, hh: hh }
        proxy = proxy || {}
        proxy.shape = ShapeType.rect;
        proxy.x = x;
        proxy.y = y;
        proxy.hw = hw;
        proxy.hh = hh;
...
export default class Shapes {
    ...
    static creator = {
        [ShapeType.rect]: ShapeCreator.rect,
        [ShapeType.circle]: ShapeCreator.circle,
        [ShapeType.line]: ShapeCreator.line
    }
    // Tests
    static tests = {
        [ShapeType.rect]: {
            [ShapeType.rect]: rect.rect,
            [ShapeType.circle]: rect.circle,
            [ShapeType.line]: rect.line,
        },
        [ShapeType.circle]: {
            [ShapeType.rect]: rect.circle,
            [ShapeType.circle]: circle.circle,
            [ShapeType.line]: circle.line,
        },
        [ShapeType.line]: {
            [ShapeType.rect]: rect.line,
            [ShapeType.circle]: circle.line,
            [ShapeType.line]: line.line,
        }
    }
    ...
    static fasttest(a, b) {
        return rect.fastRect(this.bounds(a), this.bounds(b))
    }
