...
declare const wx: {
    ...
    loadSubpackage(any): any;

    createUserInfoButton(any):any;
    createBannerAd(any):any;
    createInterstitialAd(any):any;
    createFeedbackButton(any):any;
    createGameClubButton(any):any;
    createRewardedVideoAd(any):any;
    requestSubscribeMessage(any):any;
    createGamePortal(any):any;
    /**
